        ...
        for i, index in enumerate(output_indices):
            ...
            if index != unk_index:
                ...
                if lang_word in self.all_vocabulary.word2index:
                    ...
                    result.append(self.all_vocabulary.get_unk(to_lang))
        return result

    def _map_variable(self, variable: Variable, mapping: Dict[int, int], lang):
        ...
        for t in range(input_max_length):
            for i in range(batch_size):
                ...
                output_variable[t, i] = mapping[index] if index in mapping else self.all_vocabulary.get_unk(lang)
